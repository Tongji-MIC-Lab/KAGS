...
__C.PARAM.REL_MATRIX = 'REL_MATRIX'

__C.PARAM.FC_FEATS_GROUP = 'FC_FEATS_GROUP'

__C.PARAM.GV_FEAT_FC = 'GV_FEAT_FC'

__C.PARAM.SEM_REL_FEATS = 'SEM_REL_FEATS'

__C.PARAM.KEYWORDS = 'KEY_WORDS'

__C.PARAM.EVENTS = 'EVENTS'

__C.PARAM.IMG_FEAT_MCA = 'img_feat_mca'

__C.PARAM.LANG_FEAT_MCA = 'lang_feat_mca'
...
__C.INFERENCE.COCO_PATH = '/data/ltp/CODEs/image-caption/image-captioning-master/coco-caption-master'
